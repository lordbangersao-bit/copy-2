...
const SYSTEM_PROMPT = `Você é o Assistente SIGE+, um assistente inteligente e interactivo do sistema de gestão educacional da Direcção Municipal da Educação de Namacunde.
